...
<head>
  ...
  include_once($head);
  ?>
	<title>Back to the FutureWorld, Kents Hill - Archive-opia</title>
</head>
<body>
	<?php
  $head = $_SERVER['DOCUMENT_ROOT'];
  ...
  ?>
    ...
    <div class="article text-component">
      <h1 class="color-accent text-lg text-xl@xs text-xxl@sm">Back to the FutureWorld, Kents Hill</h1>
    </div>
  </div>
    ...
    <div class="grid text-component margin-bottom-md">
      ...
      <h3 class="color-contrast-medium text-md" id="futureworld-walking"><span class="font-secondary">15 October - </span>FutureWorld Walking Tours - 11am and 2pm</h3>
